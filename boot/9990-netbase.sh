...
EOF
		...
		then
			# if ethdevice is not set, iterate the physical interfaces and add them to the interfaces list
			if [ -z ${ETHDEVICE} ]
			then
...
EOF
				...
				# when ethdevice= called on cmdline split it and iterate over it
